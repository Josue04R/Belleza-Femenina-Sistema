...
<div class="tallas-section">
    <div class="container">
        ...
        <ul>
            <li>Es importante que tengas en cuenta que la talla de tu faja puede variar según tu gusto, ya que hay muchas mujeres que están acostumbras a usar faja y cada vez quieren ponerse una una talla más pequeña porque van reduciendo medidas o su cuerpo se va moldeando, dándole horma a la figura, lo que permite que el tallaje sea menor. Por lo anterior, si es la primera vez que vas a usar fajas, elige una talla más grande.</li>
            <li>ncrementa el uso de la prenda gradualmente para que tu cuerpo se vaya adaptando al nivel de compresión.</li>
            <li>Si estas entre dos tallas, te recomendamos que elijas la más grande.</li>
            <li>Por último, sigue con atención los pasos que te damos a continuación para saber cuál es tu talla. </li>
        </ul>
